...
@HawkEntryPoint()
class V2NIMLocalConversationService {
// 消息服务
  factory V2NIMLocalConversationService() {
    if (_singleton == null) {
      _singleton = V2NIMLocalConversationService._();
    }
    return _singleton!;
  }

  V2NIMLocalConversationService._();

  static V2NIMLocalConversationService? _singleton;

  LocalConversationServicePlatform get _platform =>
      LocalConversationServicePlatform.instance;
  ...
  Future<NIMResult<NIMConversationResult>> getConversationListByOption(
      ...
      {NIMConversationOption? option}) async {
