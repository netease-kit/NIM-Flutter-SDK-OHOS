...
Map<String, dynamic> _$NIMAndroidSDKOptionsToJson(
  ...
  val['enableV2CloudConversation'] = instance.enableV2CloudConversation;
  val['enableUserInfoProvider'] = instance.enableUserInfoProvider;
  val['enableMessageNotifierCustomization'] =
