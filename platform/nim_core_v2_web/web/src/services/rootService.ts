...
class RootService {
  ...
  public init() {
    ...
    this.subscriptionService = new SubscriptionService(this,this.nim)
    this.signallingService = new SignallingService(this,this.nim)
  }
  ...
  public destroy() {
    ...
    this.signallingService?.destroy()
  }
