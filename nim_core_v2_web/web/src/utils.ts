...
import { V2NIMMessage,V2NIMMessagePushConfig } from 'nim-web-sdk-ng/dist/v2/NIM_BROWSER_SDK/V2NIMMessageService'
...
export const formatV2Message = (msg: V2NIMMessage): V2NIMMessage => {
  return {
    ...
    attachment: msg.attachment
      ...
      : void 0,
      pushConfig: msg.pushConfig?formatV2PushConfig(msg.pushConfig):void 0,
  }
}

export const formatV2PushConfig = (pushConfig:V2NIMMessagePushConfig):V2NIMMessagePushConfig => {
  return {
    ...pushConfig,
    forcePushAccountIds: typeof pushConfig.forcePushAccountIds === 'string'?[]:pushConfig?.forcePushAccountIds,
  }
}
