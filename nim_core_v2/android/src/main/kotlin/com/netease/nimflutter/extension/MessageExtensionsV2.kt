...
import com.netease.nimlib.sdk.v2.message.params.V2NIMUpdateLocalMessageParams
...
fun Map<String, *>.toMessage(): V2NIMMessage =
    V2NIMMessageBuilder
        ...
        .messageId((this["serialId"] as? Int?)?.toLong() ?: this["serialId"] as? Long ?: 0)
        .modifyTime((this["modifyTime"] as? Int?)?.toLong() ?: this["modifyTime"] as? Long ?: 0)
        .modifyAccountId(this["modifyAccountId"] as? String)
        .build()
...
fun V2NIMMessage.toMap(): Map<String, Any?> =
    mapOf(
        ...
        "conversationId" to this.conversationId,
        "createTime" to this.createTime,
        "serialId" to this.messageId,
        "modifyTime" to this.modifyTime,
        "modifyAccountId" to this.modifyAccountId
    )
...
fun Map<String, *>.toMessageAIConfig(): V2NIMMessageAIConfig =
    V2NIMMessageAIConfig().apply {
        ...
        this.airaGs = (this@toMessageAIConfig["aiRAGs"] as? List<Map<String, Any?>>)?.map {
            it.toV2NIMAIRAGInfo()
        }
        this.isAIStream = this@toMessageAIConfig["aiStream"] as? Boolean ?: false
        this.aiStreamStatus = V2NIMMessageAIStreamStatus.typeOfValue(this@toMessageAIConfig["aiStreamStatus"] as? Int ?: 0)
        this.aiStreamLastChunk = (this@toMessageAIConfig["aiStreamLastChunk"] as? Map<String, Any?>)?.toV2NIMMessageAIStreamChunk()
    }

fun Map<String, *>.toV2NIMAIRAGInfo(): V2NIMAIRAGInfo =
    V2NIMAIRAGInfo(
        this["name"] as? String,
        this["icon"] as? String,
...
fun Map<String, *>.toV2NIMMessageAIStreamChunk(): V2NIMMessageAIStreamChunk =
    V2NIMMessageAIStreamChunk(
        this["content"] as? String,
        this["messageTime"] as? Long ?: 0,
        this["chunkTime"] as? Long ?: 0,
        this["type"] as? Int ?: 0,
        this["index"] as? Int ?: 0
    )
...
fun V2NIMMessageAIConfig.toMap(): Map<String, Any?> =
    mapOf(
        ...
        "aiStream" to isAIStream,
        "aiStreamStatus" to aiStreamStatus?.value,
        "aiStreamLastChunk" to aiStreamLastChunk?.toMap()
    )

fun V2NIMMessageAIStreamChunk.toMap(): Map<String, Any?> =
    mapOf(
        "content" to content,
        "messageTime" to messageTime,
        "chunkTime" to chunkTime,
        "type" to type,
        "index" to index
    )
...
fun Map<String, *>.toMessageAntispamConfig(): V2NIMMessageAntispamConfig =
    V2NIMMessageAntispamConfigBuilder
        ...
        .withAntispamBusinessId(this["antispamBusinessId"] as? String)
        .build()
...
fun Map<String, *>.toMessageAttachment(): V2NIMMessageAttachment {
    ...
    when (messageType) {
        V2NIMMessageType.V2NIM_MESSAGE_TYPE_LOCATION.value -> {
            val latitude = this["latitude"] as? Double ?: 0.0
            val longitude = this["longitude"] as? Double ?: 0.0
            val address = this["address"] as? String?
            return V2NIMMessageAttachmentCreator.createLocationMessageAttachment(latitude, longitude, address)
        }

        else -> {
            return V2NIMMessageAttachmentBuilder
                .builder(
                    V2NIMMessageType.typeOfValue(messageType),
                    this["raw"] as? String
                ).build()
        }
    }
...
fun Map<String, *>.toMessageAIConfigParams(): V2NIMMessageAIConfigParams =
    V2NIMMessageAIConfigParams(this["accountId"] as? String).apply {
        ...
        this.isAIStream = (this@toMessageAIConfigParams["aiStream"] as? Boolean) == true
    }

fun Map<String, *>.toV2NIMMessageTargetConfig(): V2NIMMessageTargetConfig =
    V2NIMMessageTargetConfig().apply {
        this.isInclusive = this@toV2NIMMessageTargetConfig["inclusive"] as? Boolean ?: true
        this.receiverIds = (this@toV2NIMMessageTargetConfig["receiverIds"] as? List<String>?)?.toMutableList()
        this.isNewMemberVisible = this@toV2NIMMessageTargetConfig["newMemberVisible"] as? Boolean ?: false
    }
...
fun V2NIMAIModelStreamCallContent.toMap(): Map<String, Any?> =
    mapOf(
        "msg" to this.msg,
        "type" to this.type,
        "lastChunk" to this.lastChunk?.toMap()
    )

fun V2NIMAIModelStreamCallChunk.toMap(): Map<String, Any?> =
    mapOf(
        "content" to this.content,
        "chunkTime" to this.chunkTime,
        "type" to this.type,
        "index" to this.index
    )
...
fun Map<String, *>.toSendMessageParams(): V2NIMSendMessageParams =
    V2NIMSendMessageParamsBuilder
        ...
        .withTargetConfig((this["targetConfig"] as? Map<String, *>)?.toV2NIMMessageTargetConfig())
...
fun Map<String, *>.toModifyMessageParams(): V2NIMModifyMessageParams =
    V2NIMModifyMessageParams().apply {
        this.subType = this@toModifyMessageParams["subType"] as? Int
        this.text = this@toModifyMessageParams["text"] as? String
        this.attachment = (this@toModifyMessageParams["attachment"] as? Map<String, *>)?.toMessageAttachment()
        this.serverExtension = this@toModifyMessageParams["serverExtension"] as? String
        this.antispamConfig = (this@toModifyMessageParams["antispamConfig"] as? Map<String, *>)?.toMessageAntispamConfig()
        this.routeConfig = (this@toModifyMessageParams["routeConfig"] as? Map<String, *>)?.toMessageRouteConfig()
        this.pushConfig = (this@toModifyMessageParams["pushConfig"] as? Map<String, *>)?.toMessagePushConfig()
    }

fun V2NIMModifyMessageResult.toMap(): Map<String, Any?> =
    mapOf(
...
fun Map<String, *>.toMessageListOption(): V2NIMMessageListOption =
    V2NIMMessageListOptionBuilder
        ...
        .withOnlyQueryLocal(this["onlyQueryLocal"] as? Boolean ?: false)
        .build()
...
fun Map<String, *>.toClearHistoryMessageOption(): V2NIMClearHistoryMessageOption =
    V2NIMClearHistoryMessageOptionBuilder
        ...
        .withClearMode(V2NIMClearHistoryMode.typeOfValue(this["clearMode"] as? Int ?: 0))
        .build()
...
fun Map<String, *>.toCollectionOption(): V2NIMCollectionOption {
    val builder = V2NIMCollectionOptionBuilder
        .builder()
    if (this["beginTime"] as? Long? != null) {
        builder.withBeginTime(this["beginTime"] as Long)
    }
    if (this["endTime"] as? Long? != null) {
        builder.withEndTime(this["endTime"] as Long)
    }

    if (this["direction"] as? Int? != null) {
        builder.withDirection(V2NIMQueryDirection.typeOfValue(this["direction"] as Int))
    }

    if (this["anchorCollection"] as? Map<String, *>? != null) {
        builder.withAnchorCollection((this["anchorCollection"] as Map<String, *>).toCollection())
    }

    if (this["limit"] as? Int != null) {
        builder.withLimit(this["limit"] as Int)
    }

    if (this["collectionType"] as? Int != null) {
        builder.withCollectionType(this["collectionType"] as Int)
    }
...
fun V2NIMCollectionListResult.toMap(): Map<String, Any?> =
    mapOf(
        "totalCount" to this.totalCount,
        "collectionList" to this.collectionList?.map { it.toMap() }?.toList()
    )
...
fun Map<String, *>.toNIMMessageAIRegenParams(): V2NIMMessageAIRegenParams =
    V2NIMMessageAIRegenParams.Builder()
        .operationType(V2NIMMessageAIRegenOpType.typeOfValue(this["operationType"] as Int))
        .build()

fun Map<String, *>.toNIMMessageAIStreamStopParams(): V2NIMMessageAIStreamStopParams =
    V2NIMMessageAIStreamStopParams
        .Builder(V2NIMMessageAIStreamStopOpType.typeOfValue(this["operationType"] as Int))
        .updateContent(this["updateContent"] as? String)
        .build()

fun Map<String, *>.toNIMMessageSearchExParams(): V2NIMMessageSearchExParams {
    val builder = V2NIMMessageSearchExParams
        .V2NIMMessageSearchExParamsBuilder
        .builder()
        .withConversationId(this["conversationId"] as? String)

    if ((this["keywordList"] as? List<String>) != null) {
        builder.withKeywordList(this["keywordList"] as? List<String>)
    }

    if ((this["keywordMatchType"] as? Int?) != null) {
        builder.withKeywordMatchType(V2NIMSearchKeywordMathType.typeOfValue(this["keywordMatchType"] as Int))
    }

    if ((this["senderAccountIds"] as? List<String>) != null) {
        builder.withSenderAccountIds(this["senderAccountIds"] as? List<String>)
    }

    if ((this["messageTypes"] as? List<Int>) != null) {
        builder.withMessageTypes((this["messageTypes"] as? List<Int>)?.map { V2NIMMessageType.typeOfValue(it) })
    }

    if ((this["messageSubtypes"] as? List<Int>) != null) {
        builder.withMessageSubtypes(this["messageSubtypes"] as? List<Int>)
    }
    ...
    builder.withSearchStartTime((this["searchStartTime"] as? Long) ?: (this["searchStartTime"] as? Int)?.toLong() ?: 0)

    builder.withSearchTimePeriod((this["searchTimePeriod"] as? Long) ?: (this["searchTimePeriod"] as? Int)?.toLong() ?: 0)

    if ((this["pageToken"] as? String?) != null) {
        builder.withPageToken(this["pageToken"] as String)
    }

    if ((this["direction"] as? Int?) != null) {
        builder.withSearchDirection(V2NIMSearchDirection.typeOfValue(this["direction"] as Int))
    }

    if ((this["strategy"] as? Int?) != null) {
        builder.withSearchStrategy(V2NIMSearchStrategy.typeOfValue(this["strategy"] as Int))
    }

    return builder.build()
}

fun V2NIMMessageSearchResult.toMap(): Map<String, Any?> =
    mapOf(
        "count" to this.count,
        "items" to this.items?.map { it.toMap() }?.toList(),
        "nextPageToken" to this.nextPageToken,
        "hasMore" to this.hasMore()
    )

fun V2NIMMessageSearchResult.V2NIMMessageSearchItem.toMap(): Map<String, Any?> =
    mapOf(
        "conversationId" to this.conversationId,
        "messages" to this.messages?.map { it.toMap() }?.toList(),
        "count" to this.count
    )

fun V2NIMMessageListResult.toMap(): Map<String, Any?> =
    mapOf(
        "messages" to this.messages?.map { it.toMap() }?.toList(),
        "anchorMessage" to this.anchorMessage?.toMap()
    )

fun Map<String, *>.toNIMUpdateLocalMessageParams(): V2NIMUpdateLocalMessageParams {
    val builder = V2NIMUpdateLocalMessageParams
        .V2NIMUpdateLocalMessageParamsBuilder
        .builder()

    if ((this["subType"] as? Int) != null) {
        builder.withSubType(this["subType"] as Int)
    }

    if ((this["text"] as? String) != null) {
        builder.withText(this["text"] as String)
    }

    if ((this["localExtension"] as? String) != null) {
        builder.withLocalExtension(this["localExtension"] as String)
    }

    if ((this["sendingState"] as? Int) != null) {
        builder.withSendingState(V2NIMMessageSendingState.typeOfValue(this["sendingState"] as Int))
    }

    if ((this["attachment"] as? Map<String, *>) != null) {
        builder.withAttachment((this["attachment"] as Map<String, *>).toMessageAttachment())
    }
