...
//      model.setValue(nimToType.rawValue, forKeyPath: #keyPath(NIMQChatSystemNotification.toType))
//    }
//    if let type = json["type"] as? String,
//       let nimType = FLTQChatSystemNotificationType(rawValue: type)?
//       .convertNIMQChatSystemNotificationType() {
...
//      object.setValue(model.type.rawValue, forKeyPath: "type")
...
//        object.setValue(inoutType.rawValue, forKeyPath: "inoutType")
//      }
